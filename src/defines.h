...
namespace thermst
{
    namespace pin
    {
        inline constexpr uint8_t LCD_RS = 6; // 4;
        inline constexpr uint8_t LCD_EN = 7; // 6;
        ...
        inline constexpr uint8_t LCD_LED = 5; // 3;
    ...
    inline constexpr int MIN_TEMPERATURE = 20; // in CELSIUS
    inline constexpr int MAX_TEMPERATURE = 400;
